(function () {
	...
	*/
	...
	function EntryList(props) {
	  const [entryList, setEntryList] = react.exports.useState([]);
	  react.exports.useEffect(() => {
	    fetch('/api/entry').then(res => {
	      return res.json();
	    }).then(data => setEntryList(data));
	  }, []);
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("article", null, /*#__PURE__*/React.createElement("h1", null, "Andr\xE9's Zettelkasten"), /*#__PURE__*/React.createElement("p", null, "Andr\xE9's personal knowledge database")), /*#__PURE__*/React.createElement("article", null, /*#__PURE__*/React.createElement("h2", null, "Entries"), entryList.map(l => /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("details", null, /*#__PURE__*/React.createElement("summary", null, l.title), /*#__PURE__*/React.createElement("dl", null, l.tags.map(t => /*#__PURE__*/React.createElement("dt", null, t))), l.description)))));
	}

	function App() {
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(EntryList, {
	    name: "cenas"
	  }));
	}
